...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { descripcion: @option.descripcion, disponible: @option.disponible, instancia: @option.instancia, name: @option.name, votos: @option.votos }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { descripcion: @option.descripcion, disponible: @option.disponible, instancia: @option.instancia, name: @option.name, votos: @option.votos }
    assert_redirected_to option_path(assigns(:option))
  end
